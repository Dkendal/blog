...
** DONE Change Kitty shell color-scheme :fzf:kitty:fish:
   ...
   One of the more [[https://github.com/kovidgoyal/kitty/issues?q=is%3Aissue+reload+config][persistant complaints]] about the Kitty shell is the
